...
public class ArenaListCommand implements SubCommand
{
	...
	public boolean onCommand(Player player, String[] args)
	{
		...
		for(Game game : GameManager.INSTANCE.getGames())
			CommandUtil.sendMessageToPlayer(player, ChatColor.RED + game.getName() + ": " + ChatColor.GREEN + "Players: " + game.getPlayersAlive().size() + ", Status: " + game.getMode().toString().toLowerCase());
